...
class WireTransaction(componentGroups: List<ComponentGroup>, val privacySalt: PrivacySalt = PrivacySalt()) : TraversableTransaction(componentGroups) {
    ...
    private val additionalMerkleTree: MerkleTree by lazy { MerkleTreeBuilder(componentGroups, privacySalt, DefaultDigestServiceFactory.getService(Algorithm.SHA256())).getMerkleTree() }
