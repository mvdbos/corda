...
class MockNetworkMapCache : InMemoryNetworkMapCache() {
    ...
    init {
        val mockNodeA = NodeInfo(MockAddress("bankC:8080"), Party(X509Utilities.getDevX509Name("Bank C"), DummyPublicKey("Bank C")), MOCK_VERSION_INFO.platformVersion)
        val mockNodeB = NodeInfo(MockAddress("bankD:8080"), Party(X509Utilities.getDevX509Name("Bank D"), DummyPublicKey("Bank D")), MOCK_VERSION_INFO.platformVersion)
