...
data class RPCDriverDSL(
    ...
    override fun <I : RPCOps> startInVmRpcServer(rpcUser: User, nodeLegalName: String, configuration: RPCServerConfiguration, ops: I): ListenableFuture<Unit> {
        return driverDSL.executorService.submit<Unit> {
            ...
            startRpcServerWithBrokerRunning(rpcUser, nodeLegalName, configuration, ops, inVmClientTransportConfiguration)
        }
    }
    ...
    override fun <I : RPCOps> startRpcServer(
        ...
        return driverDSL.executorService.submit<RpcServerHandle> {
            ...
            startRpcServerWithBrokerRunning(rpcUser, nodeLegalName, configuration, ops, transportConfiguration)
